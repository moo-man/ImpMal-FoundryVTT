...
export class TestContext
{
    ...
    async formatItemSummary()
    {
        ...
        return await foundry.applications.handlebars.renderTemplate("systems/impmal/templates/chat/rolls/item-use.hbs", {noImage : ["icons/svg/item-bag.svg", "modules/impmal-core/assets/icons/blank.webp"].includes(item.img) , enriched, item });
    }
